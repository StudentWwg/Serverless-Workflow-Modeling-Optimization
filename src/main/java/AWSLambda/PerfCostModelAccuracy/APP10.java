...
public class APP10 {
    ...
    private static int[][] memSize = new int[3][10];
    private static String[] taskTypes = {"Disk I/O","CPU","CPU","Network I/O","CPU","CPU","CPU","CPU","CPU","CPU"};

    static {
        memSize[0] = new int[]{192, 192, 192, 192, 192, 192, 192, 192, 192, 192};
        memSize[1] = new int[]{5120, 5120, 5120, 5120, 5120, 5120, 5120, 5120, 5120, 5120};
        memSize[2] = new int[]{10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240};
    }

    public static void getAccuracyOfAPP10() {
        try {
            double[] perfAccuracy = new double[3];
            double[] costAccuracy = new double[3];
            String APPName = "APP10";
            for (int numOfMemSize = 0; numOfMemSize < memSize.length; numOfMemSize++) {
                ...
                double avgPerfCostModelDuration = Accuracy.getAvgDurationOfPerfCostModel(APP10.memConfig, APPName);
                double avgPerfCostModelCost = Accuracy.getAvgCostOfPerfCostModel(APP10.memConfig, APPName);
