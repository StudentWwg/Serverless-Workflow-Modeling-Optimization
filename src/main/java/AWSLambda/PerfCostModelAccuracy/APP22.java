...
public class APP22 {
    ...
    static {
        memSize[0] = new int[]{192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192};
        memSize[1] = new int[]{5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120,5120};
        memSize[2] = new int[]{10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240,10240};
    }

    public static void getAccuracyOfAPP22() {
        try {
            double[] perfAccuracy = new double[3];
            double[] costAccuracy = new double[3];
            String APPName = "APP22";
            for(int numOfMemSize = 0;numOfMemSize<memSize.length;numOfMemSize++){
                ...
                FunctionUpdator.updateFunctions(APP22.memConfig);
                System.out.println("The memory size of AWS Lambda have been updated. Time : " + new Date());
                ...
                double avgPerfCostModelDuration =  Accuracy.getAvgDurationOfPerfCostModel(APP22.memConfig, APPName);
                double avgPerfCostModelCost = Accuracy.getAvgCostOfPerfCostModel(APP22.memConfig, APPName);
                ...
                double[] accuracyResult = Tools.generateAccuracy(APPName,avgStateMachineDuration,avgStateMachineCost,avgPerfCostModelDuration,avgPerfCostModelCost,numOfMemSize+1);
